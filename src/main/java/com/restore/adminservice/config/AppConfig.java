package com.restore.adminservice.config;
...
@Configuration
@EntityScan({"com.restore.adminservice.entity", "com.restore.core.entity"})
@ComponentScan({"com.restore.core.service"})
@Import({AppExceptionHandler.class, WebSecurityConfig.class, CORSFilterConfig.class, TenantDataConfig.class, TenantIdentifierResolver.class, FeignConfig.class, AwsConfig.class})
